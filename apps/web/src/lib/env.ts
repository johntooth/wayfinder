...
const serverEnvSchema = z.object({
  ...
  // behind a transaction-mode pooler. See docs/guides/scaling-and-concurrency.md.
  ...
  // has not yet promoted this cache to a shared store). See docs/guides/scaling-and-concurrency.md.
